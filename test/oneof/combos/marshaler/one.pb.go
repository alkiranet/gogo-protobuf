...
type CustomOneof_CustomType struct {
	CustomType github_com_gogo_protobuf_test_custom.Uint128 `protobuf:"bytes,35,opt,name=CustomType,oneof,customtype=github.com/alkiranet/gogo-protobuf/test/custom.Uint128" json:"CustomType,omitempty"`
}
type CustomOneof_CastType struct {
	CastType github_com_gogo_protobuf_test_casttype.MyUint64Type `protobuf:"varint,36,opt,name=CastType,oneof,casttype=github.com/alkiranet/gogo-protobuf/test/casttype.MyUint64Type" json:"CastType,omitempty"`
}
